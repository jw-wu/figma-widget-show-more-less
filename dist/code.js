(() => {
  ...
  var defaultValue = {
    labelTextWhenHidden: "Show more",
    labelTextWhenVisible: "Show less",
    padding: 4
  };
  ...
  var { AutoLayout: AutoLayout3, Text: Text3, useSyncedState: useSyncedState2, useWidgetNodeId, usePropertyMenu } = widget4;
  function ShowHide() {
    const [visible, setVisibility] = useSyncedState2("visibility", true), [label, setLabel] = useSyncedState2("label", defaultValue.labelTextWhenVisible), [labelTextWhenHidden, setLabelTextWhenHidden] = useSyncedState2("labelTextWhenHidden", defaultValue.labelTextWhenHidden), [labelTextWhenVisible, setLabelTextWhenVisible] = useSyncedState2("labelTextWhenVisible", defaultValue.labelTextWhenVisible), [labelColor, setLabelColor] = useSyncedState2("labelColor", color.brand1.primary), [fontSize, setFontSize] = useSyncedState2("fontSize", typography.size.medium), [padding, setPadding] = useSyncedState2("padding", defaultValue.padding);
